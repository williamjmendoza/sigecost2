<?php
	...
	class ModeloInstanciaETAplicacionOfimatica
	{
		...
		public static function actualizarInstancia(EntidadInstanciaETAplicacionOfimatica $instancia)
		{
			$preMsg = 'Error al actualizar la instancia de elemento tecnológico en aplicación ofimática.';
			...
			try
			{
				...
				$query = '
						...
						WHERE
						{
							?iri rdf:type :'.SIGECOST_FRAGMENTO_APLICACION_OFIMATICA.' .
							?iri :nombreAplicacionPrograma ?nombreAplicacion .
						 	?iri :versionAplicacionPrograma ?versionAplicacion .
		...
		{
			$preMsg = 'Error al buscar el contador de las instancias elemento tecnologico de aplicación ofimatica..';

			// Buscar la cantidad de instancias de elemento tecnologico aplicación ofimatica.
			$query = '
					PREFIX : <'.SIGECOST_IRI_ONTOLOGIA_NUMERAL.'>
					PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
		...
		{
			$preMsg = 'Error al eliminar la instancia de elemento tecnol&oacute;ico aplicaci&oacute;n ofim&aacute;tica.';
