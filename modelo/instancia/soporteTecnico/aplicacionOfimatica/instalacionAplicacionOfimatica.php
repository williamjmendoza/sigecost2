<?php
	...
	{
		public static function actualizarInstancia(EntidadInstanciaSTAplicacionOfimaticaInstalacionAplicacionOfimatica $instancia)
		{
		...
		{
			$preMsg = 'Error al eliminar la instancia de soporte técnico en aplicación ofimática para instalación de aplicación ofimática.';
