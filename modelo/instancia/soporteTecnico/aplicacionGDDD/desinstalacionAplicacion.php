<?php
	...
	{
		public static function actualizarInstancia(EntidadInstanciaSTAplicacionGDDDDesInstalacionAplicacion $instancia)
		{
			$preMsg = 'Error al actualizar la instancia de soporte técnico en desinstalacion de aplicacion gráfica dibujo digital y diseño.';
				...
				*/
				...
				$query = '
						...
						INSERT INTO <'.SIGECOST_IRI_GRAFO_POR_DEFECTO.'>
						{
							...
							<'.$instancia->getIri().'> :aplicacionGraficaDigitalDibujoDiseno <'.$instancia->getAplicacionPrograma()->getIri().'> .
		...
		{
			$preMsg = 'Error al buscar el contador de las instancias de soporte técnico en desinstalacion de aplicación gráfica digital, dibujo y diseño..';

			// Buscar la cantidad de instancias de soporte técnico en desinstalacion aplicación gráfica digital, dibujo y diseño.
			$query = '
					PREFIX : <'.SIGECOST_IRI_ONTOLOGIA_NUMERAL.'>
					PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
		...
		{
			$preMsg = 'Error al eliminar la instancia de soporte técnico en  aplicación de programa para instalación de aplicación gráfica digital,dibujo y diseño.';
		...
		public static function establecerNombrePatron(EntidadInstanciaSTAplicacionGDDDDesinstalacionAplicacion $instancia)
		{
			$preMsg = "Error al establecer el nombre del patrón de soporte técnico para la instancia" . 
				" de s. t. para la desinstalación de una aplicación gráfica digital, dibujo y diseño.";
				
			try
			{
				$aplicacion = ModeloInstanciaETAplicacionGraficaDigitalDibujoDiseno::obtenerAplicacionPorIri($instancia->getAplicacionPrograma()->getIri());
		
				if($aplicacion === null || $aplicacion === false)
					throw new Exception($preMsg . ' Los datos de la aplicación G. D. D. D. no pudieron ser consultados.');
				
				$nombre = SIGECOST_FRAGMENTO_S_T_DESINSTALACION_APLICACION_GRAFICA_DIGITAL_DIBUJO_DISENO .
