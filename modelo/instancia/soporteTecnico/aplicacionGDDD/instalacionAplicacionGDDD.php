<?php
	...
	class ModeloInstanciaSTAplicacionGDDDInstalacionAplicacionGDDD
	{
		...
		public static function actualizarInstancia(EntidadInstanciaSTAplicacionGDDDInstalacionAplicacionGDDD $instancia)
		{
			$preMsg = 'Error al actualizar la instancia de soporte técnico en instalacion de aplicacion gráfica dibujo digital y diseño.';
		...
		public static function existeInstancia($instancia)
		{
			...
			try
			{
				...
				$query = '
						...
						ASK
						{
							?instanciaST rdf:type :'.SIGECOST_FRAGMENTO_S_T_INSTALACION_APLICACION_GRAFICA_DIGITAL_DIBUJO_DISENO.' .
		...
		public static function establecerNombrePatron(EntidadInstanciaSTAplicacionGDDDInstalacionAplicacionGDDD $instancia)
		{
			...
			try
			{
				...
				$nombre = SIGECOST_FRAGMENTO_S_T_INSTALACION_APLICACION_GRAFICA_DIGITAL_DIBUJO_DISENO .
