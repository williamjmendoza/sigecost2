	...
	class ControladorInstanciaETAplicacionReproduccionSonidoVideo extends ControladorInstanciaETAplicacionPrograma
	{
		...
		public function eliminar()
		{
			...
			try
			{
				...
				if(($resultado = ModeloInstanciaETAplicacionReproduccionSonidoVideo::esInstanciaUtilizada($iri)) === null)
				...
				// Eliminar la instancia de elemento tecnológico reproduccion sonido y video, de la base de datos
				$resultado = ModeloInstanciaETAplicacionReproduccionSonidoVideo::eliminarInstancia($iri);
