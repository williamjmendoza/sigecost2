	...
	class ControladorInstanciaETComputadorPortatil extends ControladorInstanciaETEquipoComputacion
	{
		...
		public function actualizar()
		{
			try
			{
				...
				if(count($GLOBALS['SigecostErrors']['general']) == 0)
				{
					...
					$GLOBALS['SigecostInfo']['general'][] = "Instancia de aplicación computador portátil guardada satisfactoriamente.";
		...
		public function eliminar()
		{
			try
			{
				...
				$resultado = ModeloInstanciaETComputadorPortatil::eliminarInstancia($iri);
