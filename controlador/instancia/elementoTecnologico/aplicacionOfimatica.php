	...
	class ControladorInstanciaETAplicacionOfimatica extends ControladorInstanciaETAplicacionPrograma
	{
		...
		public function actualizar()
		{
			try
			{
				...
				{
					// Consultar si existe una instancia de elemento tecnológico en aplicación ofimática, con las mismas características
					if(($existeInstancia = ModeloInstanciaETAplicacionOfimatica::existeAplicacion($form->getAplicacionPrograma())) === null)
						throw new Exception("La instancia no pudo ser actualizada.");
					
					// Validar si existe una instancia de elemento tecnológico en aplicación ofimática, con las mismas características
					if ($existeInstancia === true)
						throw new Exception("Ya existe una instancia con las mismas caracter&iacute;sticas.");
					
					// Actualizar la instancia de elemento tecnológico aplicación ofimática, en la base de datos
					$resultado = ModeloInstanciaETAplicacionOfimatica::actualizarInstancia($form->getAplicacionPrograma());
		...
		public function modificar()
		{
			try
			{
				...
				if( ($instancia = ModeloInstanciaETAplicacionOfimatica::obtenerAplicacionPorIri($iri)) === null )
