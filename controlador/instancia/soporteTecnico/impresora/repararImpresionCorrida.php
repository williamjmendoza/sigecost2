<?php
	...
	class ControladorInstanciaSTImpresoraRepararImpresionCorrida extends ControladorInstanciaSTImpresora
	{
		...
		public function buscar()
		{
			...
			$totalElementos = ModeloInstanciaSTImpresoraRepararImpresionCorrida::buscarInstanciasTotalElementos();
			...
			$instancias = ModeloInstanciaSTImpresoraRepararImpresionCorrida::buscarInstancias($parametros);
