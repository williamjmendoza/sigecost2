	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="active"><a href="aplicacionOfimatica.php?accion=Buscar">Buscar</a></li>
			</ul>
		</div>
		...
		<div class="container">
			...
			<h1>Instancias del elemento tecnol&oacute;gico aplicaci&oacute;n ofim&aacute;tica</h1>
			</div>
