	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				<li class="active"><a href="aplicacionProduccionAudiovisualMusica.php?accion=insertar">Insertar</a></li>
		...
		<div class="container">
			...
			<form class="form-horizontal" role="form" method="post" action="aplicacionProduccionAudiovisualMusica.php">
