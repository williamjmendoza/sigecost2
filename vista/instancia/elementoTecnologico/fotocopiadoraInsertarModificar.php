	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<?php echo ($form->getTipoOperacion() == Formulario::TIPO_OPERACION_INSERTAR) ? ' class="active"' : ''; ?>
				 	><a href="fotocopiadora.php?accion=insertar">Insertar</a></li>
		...
		<div class="container">
			...
			<div class="page-header">
				<h1>
					Instancia del elemento tecnol&oacute;gico fotocopiadora<?php
			...
			<form class="form-horizontal" role="form" method="post" action="fotocopiadora.php">
