	...
	<body>
		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="active"><?php
					if($esAdministradorOntologia) {
						echo "Instancia de aplicaci&oacute;n producci&oacute;n audiovisual y m&uacute;sica";
					} else {
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li><a href="aplicacionProduccionAudiovisualMusica.php?accion=Buscar">Consultar</a></li>
		...
		<div class="container">
			...
			<div class="page-header">
				<h1>Instancia de aplicaci&oacute;n producci&oacute;n audiovisual y m&uacute;sica</h1>
			</div>
			
			<form id="formAplicacionProduccionAudiovisualMusica" class="form-horizontal" role="form" method="post" action="aplicacionProduccionAudiovisualMusica.php">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
						...
						<button type="button" class="btn btn-primary" onclick="eliminarInstancia('formAplicacionProduccionAudiovisualMusica');">Eliminar</button>
					</div>
				</div>
			</form>
