	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li><a href="aplicacionReproduccionSonidoVideo.php?accion=Buscar">Buscar</a></li>
			...
			<form id="formAplicacionReproduccionSonidoVideo" class="form-horizontal" role="form" method="post" action="aplicacionReproduccionSonidoVideo.php">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
						...
						<button type="button" class="btn btn-primary" onclick="eliminarInstancia('formAplicacionReproduccionSonidoVideo');">Eliminar</button>
					</div>
				</div>
			</form>
