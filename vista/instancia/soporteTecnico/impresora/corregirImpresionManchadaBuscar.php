	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="active"><a href="corregirImpresionManchada.php?accion=Buscar">Buscar</a></li>
			</ul>
		</div>
		...
		<div class="container">
			...
			?>
						<tr>
							...
							<td>
								<form class="form-horizontal" role="form" action="corregirImpresionManchada.php" method="post">
