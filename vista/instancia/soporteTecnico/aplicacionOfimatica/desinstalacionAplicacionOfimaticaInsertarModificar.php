	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				<li class="active"><a href="desinstalacionAplicacionOfimatica.php?accion=insertar">Insertar</a></li>
				<li><a href="desinstalacionAplicacionOfimatica.php?accion=Buscar">Buscar</a></li>
			</ul>
		</div>
