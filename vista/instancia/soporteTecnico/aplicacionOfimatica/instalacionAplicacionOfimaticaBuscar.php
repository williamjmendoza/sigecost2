	...
	<body>
		...
		<div class="container">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="active"><a href="instalacionAplicacionOfimatica.php?accion=Buscar">Buscar</a></li>
			</ul>
		</div>
							...
							<td>
								<form class="form-horizontal buscarOpciones" role="form" action="instalacionAplicacionOfimatica.php" method="post">
									...
									<div class="form-group">
										<button type="submit" class="btn btn-primary btn-xs" role="button" onclick="setAccion('modificar');">Modificar</button>
										<button type="submit" class="btn btn-primary btn-xs" role="button" onclick="setAccion('desplegarDetalles');">Ver Detalles</button>
									</div>	
								</form>
							</td>
						</tr>
