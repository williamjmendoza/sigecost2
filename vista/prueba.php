	...
	<body>
		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Sigecost</a>
				</div>
		...
		<div class="container">
			<div class="jumbotron">
				...
				<h1>Hello, world!</h1>
				<p>
					Esta es una unidad de héroe sencilla, un componente simple de estilo de jumbotron
					para llamar la atención al contenido especial o información.
				</p>
